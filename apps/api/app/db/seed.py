...
Populates synthetic test data (users, profiles, skills, projects, facilities, problem-solutions).
...
from app.models import (
    ...
    ProjectVisibility, ProjectStatus, ContributorRole,
    Facility, Equipment, FacilityStatus, EquipmentStatus, AvailabilityStatus,
    ResearchItem, ResearchStatus,
...
def run_seed():
    ...
    try:
        ...
        # 6. Problem / Solution Institutional Memory
        problem1 = ProblemSolution(
            ...
            technologies=["ESP32", "C++", "FreeRTOS", "FastAPI"],
            domain="IoT & Embedded Systems",
        ...
        research1 = ResearchItem(
            ...
            abstract="We propose a adaptive routing technique for micro-aerial vehicles operating under lossy RF environments.",
